...
const Investment = () => {
  return (
    <div className="bg-[#2B076E] py-10 text-white font-rubik">
      <div className="text-center">
        <h2 className="font-bold sm:text-3xl text-2xl mb-2">
      ...
      <div className="flex sm:flex-row flex-col w-full sm:px-[7%] sm:py-10 p-4 gap-20">
        <div className="w-1/3">
      ...
      <div className="flex sm:flex-row flex-col items-center w-full gap-20 sm:pr-[7%] mt-20">
      ...
      <div className="flex sm:flex-row flex-col w-full sm:px-[7%] sm:py-10 p-4 gap-20 mt-20">
        <div className="w-1/3">
